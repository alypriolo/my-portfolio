  ...
  return (
    <section className="contact" id="contact" ref={ref}>
      ...
      <div className="container contact__inner">
        <div className="fade-in contact__text">
          <span className="section-label">Contact</span>
          <h2 className="section-title contact__title">Let's talk.</h2>
          <p className="contact__body">
            Whether it's about work, a project idea, or just to connect, feel free to reach out.
          </p>
        </div>

        <div className="contact__cards fade-in">
          <a
            href="mailto:alypriolo@gmail.com"
          ...
          >
            ...
            <div>
              ...
              <p className="contact-card__value">alypriolo@gmail.com</p>
            </div>
          </a>
          ...
          >
            ...
            <div>
              ...
              <p className="contact-card__value">alessandrapriolo</p>
            </div>
          </a>

          <a
            href="https://github.com/alypriolo"
            target="_blank"
            rel="noopener noreferrer"
            className="contact-card"
          >
            ...
            <div>
              ...
              <p className="contact-card__value">alypriolo</p>
            </div>
          </a>
